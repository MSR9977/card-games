!(function (t, e) {
  ...
  let St = class {
    ...
    static build(t, e) {
      if (
        ...
        (t.options = xt(t.options, t.root, _t)),
        t.animations.map((e) => {
          ((e.settings = xt(e.s, t.root, _t)),
            delete e.s,
    ...
    static init() {
      const t = window.__SVGATOR_PLAYER__ && window.__SVGATOR_PLAYER__[_t];
  ...
  var Ot = {
    ...
    Bt = {
      ...
      u: (t, e) => (n) => {
        const r = e(n);
        (t.setAttribute("width", kt(r.width)),
          t.setAttribute("height", kt(r.height)));
      },
    };
  let jt = {},
    Tt = null;
  ...
  function Rt(t, e, n, r = !1) {
    const i = { x: Vt(t.x, e.x, n), y: Vt(t.y, e.y, n) };
    return (
      r &&
        (i.a = (function (t, e) {
  ...
  function Pt(t, e, n, r, i = !1) {
    let s = Ct(t, e, null, n, r);
    return (
      s || (s = { x: $t(t.x, e.x, n.x, r), y: $t(t.y, e.y, n.y, r) }),
      i &&
        (s.a = (function (t, e, n, r) {
          return Math.atan2(Dt(t.y, e.y, n.y, r), Dt(t.x, e.x, n.x, r));
        })(t, e, n, r)),
      s
    );
  }
  ...
  function zt(t, e, n, r, i, s = !1) {
    let o = Ct(t, e, n, r, i);
    return (
      o || (o = { x: qt(t.x, e.x, n.x, r.x, i), y: qt(t.y, e.y, n.y, r.y, i) }),
      s &&
        (o.a = (function (t, e, n, r, i) {
          return Math.atan2(
            Lt(t.y, e.y, n.y, r.y, i),
            Lt(t.x, e.x, n.x, r.x, i),
          );
        })(t, e, n, r, i)),
      o
    );
  ...
  function Gt(t, e, n, r = !1) {
    if (Yt(e)) {
      if (Ut(n)) return Pt(e, n.start, n, t, r);
    } else if (Yt(n)) {
      if (Ht(e)) return Pt(e, e.end, n, t, r);
    } else {
      if (Ht(e))
        return Ut(n) ? zt(e, e.end, n.start, n, t, r) : Pt(e, e.end, n, t, r);
      if (Ut(n)) return Pt(e, n.start, n, t, r);
    }
    return Rt(e, n, t, r);
  }
  ...
  var Xt = {
    ...
    ee = {
      f: function (t, e = " ") {
        return (t && t.length > 0 && (t = t.map((t) => n(t, 4))), Et(t, e));
      },
      i: function (t, e, r) {
        let i = e.length,
          s = r.length;
  ...
  function se(t, e, n, r, i, s, o, u) {
    return (
      ...
      (r) => {
        const i = n(r, t, oe);
        if (!i) return "none";
        if ("c" === i.t) return Mt(i.v);
        if ("g" === i.t) {
          if (!e[i.r]) return Nt(i.r);
          const t = e[i.r];
          return (
            (function (t, e) {
              let n = t.s;
              ...
              for (let t = 0, r = n.length, i = e.length - 1; t < r; t++)
                (n[t].setAttribute("stop-color", Mt(e[Math.min(t, i)].c)),
                  n[t].setAttribute("offset", e[Math.min(t, i)].o));
            })(t, i.s),
            Object.keys(ie).forEach((e) => {
              if (void 0 === i[e]) return;
              if ("object" == typeof ie[e])
                return void Object.keys(ie[e]).forEach((n) => {
    ...
    if (e && n) {
      ...
      if (r === n.t)
        switch (e.t) {
          ...
          case "g":
            if (e.r === n.r) {
              const i = { t: r, s: ue(t, e.s, n.s), r: e.r };
              return (
                e.gt && n.gt && (i.gt = nt(t, e.gt, n.gt)),
                e.c
                  ? ((i.c = Z(t, e.c, n.c)), (i.rd = X(t, e.rd, n.rd)))
                  : e.f && ((i.f = Z(t, e.f, n.f)), (i.to = Z(t, e.to, n.to))),
                i
              );
            }
        }
      if (("c" === e.t && "g" === n.t) || ("c" === n.t && "g" === e.t)) {
        ...
        return ((i.s = "c" === e.t ? ue(t, s, i.s) : ue(t, i.s, s)), i);
      }
    }
    return H(t, e, n);
  }
  function ue(t, e, n) {
    if (e.length === n.length) return e.map((e, r) => le(t, e, n[r]));
  ...
  function he(t, e, n) {
    ...
    for (let o = 0; o < r; o++) {
      ...
      if (((s = fe[e[o].type]), !s)) return H(t, e, n);
  ...
  const de = {
      ...
      return s
        ? (t) => {
            (r.setAttribute("stdDeviation", It(t.blur)),
              ...
              s.setAttribute("flood-color", Mt(t.color)));
          }
        : null;
    },
    "inner-shadow"(t, e, n) {
    ...
    opacity: (t, e, n) =>
      (t = n.getElementById(e + "-A"))
        ? (e) => t.setAttribute("tableValues", "0 " + kt(e))
        : null,
  ...
  const ge = ["R", "G", "B"];
  function pe(t, e) {
    const n = ge.map((n) => t.getElementById(e + "-" + n) || null);
        ...
        t = t.map((t) =>
          t && de[t[0]]
            ? (e.getElementById(t[1]),
              de[t[0]](e.getElementById(t[1]), t[1], e))
            : null,
        );
        const n = t.length;
        return (e) => {
  ...
  class we extends St {
    static build(t) {
      let e = super.build(t, ye);
      if (!e) return null;
      let { el: n, options: r, player: i } = e;
      (be.adjustLink(n), i.play());
    }
  }
  return (we.init(), we);
});
    ...
    animations: [
      {
        elements: {
          eexVklFM63q4: {
            transform: {
              data: {
                o: { x: 1000, y: 981.572305, type: "corner" },
                s: { x: 1.000003, y: 1.015038 },
                t: { x: -1016.913096, y: -985.184791 },
              },
              keys: {
                r: [
                  { t: 0, v: -1620 },
          ...
          eexVklFM63q11: {
            transform: {
              ...
              keys: {
                r: [
                  ...
                  { t: 7700, v: 0, e: [1, 0] },
                  { t: 10000, v: 720, e: [0.415, 0.08, 0.115, 0.955] },
                  { t: 17700, v: 0, e: [1, 0] },
                ],
              },
            },
            fill: [
              ...
              { t: 10000, v: { t: "c", v: { r: 255, g: 255, b: 255, a: 1 } } },
              { t: 17700, v: { t: "c", v: { r: 210, g: 219, b: 236, a: 1 } } },
            ],
          },
          eexVklFM63q12: {
            transform: {
        ...
        s: "",
      },
    ],
    options: "MJDAxMDg4UDJmODA4MTBZlN2Y4MTJmNDcyZjcB5N2M2ZTcxMmY4YQ|",
  },
  "__SVGATOR_PLAYER__",
  window,
  document,
